...
with open("../datasets/michael_dataset.json", "r", encoding="utf-8") as f:
...
model.save_pretrained("./michael-lora-adapter")
tokenizer.save_pretrained("./michael-lora-adapter")
