...
with open("../datasets/dwight_dataset.json", "r", encoding="utf-8") as f:
    train_data = json.load(f)

print(f"Loaded {len(train_data)} training examples", flush=True)
...
model.save_pretrained("./dwight-lora-adapter")
tokenizer.save_pretrained("./dwight-lora-adapter")
